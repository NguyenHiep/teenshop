	...
	public function __construct($totalItems, $totalItemsPerPage = 1, $pageRange = 3, $currentPage = 1){
		...
		if($this->totalPage > 1){
			...
			if($this->currentPage > 1){
				...
				$prev 	= '<li><a href="'.$link.'/page/'.($this->currentPage-1).'">Pre</a></li>';
			}
		
			$next 	= '<li  class="disabled"><a rel="nofollow"> Next </a> </li>';
			$end 	= '<li><a rel="nofollow"> End</li>';
			if($this->currentPage < $this->totalPage){
				$next 	= '<li><a href="'.$link.'/page/'.($this->currentPage+1).'">Next</a></li>';
        ...
        $paginationHTML = '<ul class="pagination">'  . $prev. $listPages . $next . '</ul>';
		}
